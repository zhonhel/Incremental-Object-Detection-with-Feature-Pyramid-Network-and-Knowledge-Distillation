...
from detectron.ops.mySplitOp import mySplitOp
...
class DetectionModelHelper(cnn.CNNModelHelper):
    ...
    def CollectAndDistributeFpnRpnProposals(self):
        ...
        rois_names = rois_names+['rpn_rois_toothbrush' + str(l) for l in range(k_min, k_max + 1)]
        score_names = [
    ...
    def mySplit(self):
        ...
        blobs_out = [core.ScopedBlobReference(b) for b in blobs_out]
        self.net.Python(mySplitOp(self.train).forward)(blobs_in, blobs_out, name='mySplitOp')
