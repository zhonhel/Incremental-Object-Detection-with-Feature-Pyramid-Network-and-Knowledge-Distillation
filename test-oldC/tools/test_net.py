...
if __name__ == '__main__':
    ...
    if 'dior_2nd' in cfg.TEST.WEIGHTS:
        ...
        os.system('ln -s /home/wsh/dior/coco/annotationsO_2nd ./detectron/datasets/data/coco/annotations')
    elif 'dior_3rd' in cfg.TEST.WEIGHTS:
        os.system('ln -s /home/wsh/dior/coco/coco_train2014 ./detectron/datasets/data/coco/coco_train2014')
        os.system('ln -s /home/wsh/dior/coco/coco_val2014 ./detectron/datasets/data/coco/coco_val2014 ')
        os.system('ln -s /home/wsh/dior/coco/annotationsO_3rd ./detectron/datasets/data/coco/annotations')
    elif 'dior_4th' in cfg.TEST.WEIGHTS:
        os.system('ln -s /home/wsh/dior/coco/coco_train2014 ./detectron/datasets/data/coco/coco_train2014')
        os.system('ln -s /home/wsh/dior/coco/coco_val2014 ./detectron/datasets/data/coco/coco_val2014 ')
        os.system('ln -s /home/wsh/dior/coco/annotationsO_4th ./detectron/datasets/data/coco/annotations')
    elif 'dior_5th' in cfg.TEST.WEIGHTS:
        os.system('ln -s /home/wsh/dior/coco/coco_train2014 ./detectron/datasets/data/coco/coco_train2014')
        os.system('ln -s /home/wsh/dior/coco/coco_val2014 ./detectron/datasets/data/coco/coco_val2014 ')
        os.system('ln -s /home/wsh/dior/coco/annotationsO_5th ./detectron/datasets/data/coco/annotations')
    elif '2020.10.6' in cfg.TEST.WEIGHTS:
        os.system('ln -s /home/wsh/dior/coco/coco_train2014 ./detectron/datasets/data/coco/coco_train2014')
        os.system('ln -s /home/wsh/dior/coco/coco_val2014 ./detectron/datasets/data/coco/coco_val2014 ')
        os.system('ln -s /home/wsh/dior/coco/annotationsO ./detectron/datasets/data/coco/annotations')
    else:
        raise Exception
