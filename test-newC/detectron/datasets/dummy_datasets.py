...
def get_coco_dataset():
    ...
    ds = AttrDict()
    classes = [
        '__background__', 'basketballcourt', 'storagetank', 'harbor', 'Expressway-toll-station', 'Expressway-Service-area',
        'golffield', 'overpass', 'stadium', 'trainstation', 'windmill', 'fire hydrant',
